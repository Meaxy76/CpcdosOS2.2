	...
	.stabs "C:\\Users\\meaxy\\Desktop\\Devworks\\CpcdosOS2.1LTS\\build\\",100,0,0,.Lt_0002
...
.Lt_0002:
	...
	.stabs "FB\\__FB__PE_CPCDOSOSX_INIT___CPCDOS_INIT_1.BAS",132,0,0,.Lt_0007
.Lt_0007:
...
.Lt_0009:
	.stabs "",36,0,0,.Lt_0009-___FB__PE_CpcdosOSx_INIT_
	.stabs "main",42,0,1,_main
	.stabd 68,0,1
	.stabs "main:F1",36,0,1,_main
	.stabs "__FB_ARGC__:p1",160,0,0,8
	.stabs "__FB_ARGV__:p18=*19=*4",160,0,0,12
.balign 16
...
##DIM _RETOUR AS INTEGER=__CPCDOS_INIT_1(_ARG0):__FB__PE_CpcdosOSx_INIT_=_RETOUR:end function:__FB__PE_CpcdosOSx_INIT_(0)
	...
	add esp, 4
.stabn 68,0,8,.Lt_000A-_main
.Lt_000B:
##end 1
	push 1
	call _fb_End
	add esp, 4
.stabn 68,0,10,.Lt_000B-_main
.Lt_0004:
	push 0
	call _fb_End
	add esp, 4
...
.Lt_000C:
	.stabs "",36,0,0,.Lt_000C-_main
	.stabs "",100,0,0,.Lt_000D
.Lt_000D:
