...
void *Thread_Updater(void*);
extern "C" void Interruption_Timer(long signal);
void ptr_Update_TID(unsigned long Adresse, unsigned long TID);

#define ENTRER_SectionCritique cpinti::task_manager::begin_SectionCritique
#define SORTIR_SectionCritique cpinti::task_manager::end_SectionCritique
...
namespace cpinti
{
	...
	{ 
		...
		#define MAX_PROCESSUS 	256 // Temporaire
