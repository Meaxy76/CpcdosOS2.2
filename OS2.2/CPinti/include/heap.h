...
// int 			NP_cpinti_task_manager::thread_args::ARG1 			= 0;
// unsigned int 	NP_cpinti_task_manager::thread_args::ARG2 			= 0;
// const char* 	NP_cpinti_task_manager::thread_args::ARG3				= 0;
// const char* 	NP_cpinti_task_manager::thread_args::ARG4 			= 0;
// const char* 	NP_cpinti_task_manager::thread_args::ARG5 			= 0;

// std::string 	NP_cpinti_task_manager::thread_args::ARG3_STR 		= "";
// std::string 	NP_cpinti_task_manager::thread_args::ARG4_STR 		= "";
// std::string 	NP_cpinti_task_manager::thread_args::ARG5_STR 		= "";

// unsigned int 	NP_cpinti_task_manager::thread_args::TID 				= 0; /* ID du thread */
// unsigned int 	NP_cpinti_task_manager::thread_args::PID				= 0; /* ID du processus */
// unsigned int	NP_cpinti_task_manager::thread_args::USER_ID				= 0; /* ID du USER */
// unsigned int	NP_cpinti_task_manager::thread_args::OS_ID				= 0; /* ID de l'OS */
// unsigned int 	NP_cpinti_task_manager::thread_args::KERNEL_ID 		= 0; /* ID du kernel */
// const char* 	NP_cpinti_task_manager::thread_args::NomThread 		= 0; /* Nom du thread */
// std::string 	NP_cpinti_task_manager::thread_args::NomThread_STR 	= "";
...
// bool NP_cpinti_task_manager::Gestionnaire_des_taches::switch_SIMPLE_doevents 	= false;
// double NP_cpinti_task_manager::Gestionnaire_des_taches::Temps_Total 			= 0;
// unsigned int NP_cpinti_task_manager::Gestionnaire_des_taches::NB_Cycle_CPU 	= 0;
// unsigned int NP_cpinti_task_manager::Gestionnaire_des_taches::NB_MAX_Cycle_CPU = 0;
// unsigned int NP_cpinti_task_manager::Gestionnaire_des_taches::Cycle_CPU_res 	= 0;
// unsigned int	NP_cpinti_task_manager::Gestionnaire_des_taches::Test_TIME	= 0;

// unsigned int NP_cpinti_task_manager::Gestionnaire_des_taches::NB_processus 	= 0;
// unsigned int NP_cpinti_task_manager::Gestionnaire_des_taches::NB_thread 		= 0;

// time_t NP_cpinti_task_manager::Gestionnaire_des_taches::Temps_DEPART;
// time_t NP_cpinti_task_manager::Gestionnaire_des_taches::Temps_ARRIVE;
